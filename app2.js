...
d ${d.color}44`, color: d.color, borderRadius: 9, padding: "0 4px" } }, d.short), it.lastArrived && React.createElement("span", { style: { fontSize: 7, color: "#44cc88" } }, "\uD83D\uDCE6 ", it.lastArrived), it.lastRetired && React.createElement("span", { style: { fontSize: 7, color: "#ffaa00" } }, "\uD83D\uDDD1\uFE0F ", it.lastRetired), it.lastFinished && React.createElement("span", { style: { fontSize: 7, color: "#ff8888" } }, "\uD83D\uDD34 ", it.lastFinished)))), React.createElement("div", { style: { textAlign: "center" } }, React.createElement("div", { style: { display: "flex", alignItems: "center", justifyContent: "center", gap: 2 } }, React.createElement("button", { onClick: () => adjStock(it.id, -1), style: S.mini }, "\u2212"), React.createElement("span", { style: { fontSize: 13, fontWeight: 700, color: st.c, minWidth: 22, textAlign: "center" } }, it.stock), React.createElement("button", { onClick: () => adjStock(it.id, 1), style: S.mini }, "+"))), React.createElement("div", { style: { textAlign: "center" } }, React.createElement("div", { style: { display: "flex", alignItems: "center", justifyContent: "center", gap: 2 } }, React.createElement("button", { onClick: () => adjBackup(it.id, -1), style: S.mini }, "\u2212"), React.createElement("span", { style: { fontSize: 13, fontWeight: 700, color: "#c8964e", minWidth: 22, textAlign: "center" } }, it.backup), React.createElement("button", { onClick: () => adjBackup(it.id, 1), style: S.mini }, "+"))), React.createElement("div", { style: { textAlign: "center" } }, editParId === it.id ? React.createElement("input", { type: "number", value: editParV, onChange: e => setEditParV(e.target.value), onBlur: () => commitPar(it.id), onKeyDown: e => { if (e.key === "Enter") commitPar(it.id); if (e.key === "Escape") setEditParId(null); }, autoFocus: true, style: { width: 34, background: "#1a1208", border: "1px solid #c8964e", borderRadius: 4, color: "#f0e6d0", fontSize: 11, textAlign: "center", padding: "1px 2px", outline: "none" } }) : React.createElement("button", { onClick: () => { setEditParId(it.id); setEditParV(String(it.par)); }, style: { background: "rgba(200,150,78,.1)", border: "1px dashed #c8964e44", borderRadius: 4, color: "#c8964e", fontSize: 11, fontWeight: 700, cursor: "pointer", padding: "1px 6px" } }, it.par, React.createElement("span", { style: { fontSize: 6, opacity: .5 } }, " \u270F\uFE0F"))), React.createElement("div", { style: { textAlign: "center" } }, cycles.avgDays > 0 ? React.createElement("div", null, React.createElement("div", { style: { fontSize: 10, fontWeight: 700, color: "#6eb5c8" } }, cycles.avgDays, "d"), React.createElement("div", { style: { fontSize: 7, color: "#4a6a7a" } }, cycles.cycles, " ciclo", cycles.cycles !== 1 ? "s" : "")) : React.createElement("span", { style: { fontSize: 10, color: tc } }, tr, it.velocity)), React.createElement("div", { style: { textAlign: "center" } }, React.createElement("span", { style: { background: `${st.c}22`, border: `1px solid ${st.c}55`, color: st.c, borderRadius: 20, padding: "1px 6px", fontSize: 7, fontWeight: 700 } }, st.l)), React.createElement("div", { style: { textAlign: "center", display: "flex", flexDirection: "column", gap: 3, alignItems: "center" } }, React.createElement("div", { style: { display: "flex", gap: 3 } }, React.createElement("button", { onClick: () => markArrived(it.id), title: "Registrar llegada hoy", style: { background: "rgba(68,204,136,.12)", border: "1px solid rgba(68,204,136,.3)", color: "#44cc88", borderRadius: 4, padding: "2px 5px", cursor: "pointer", fontSize: 8, lineHeight: 1.4 } }, "\uD83D\uDCE6"), React.createElement("button", { onClick: () => { setRetireItem(it); setRetireQty("1"); setRetireReason(""); }, title: "Retirar producto", style: { background: "rgba(255,170,0,.1)", border: "1px solid rgba(255,170,0,.3)", color: "#ffaa44", borderRadius: 4, padding: "2px 5px", cursor: "pointer", fontSize: 8, lineHeight: 1.4 } }, "\uD83D\uDDD1\uFE0F"), React.createElement("button", { onClick: () => markFinished(it.id), title: "Marcar como agotado", style: { background: "rgba(255,68,68,.1)", border: "1px solid rgba(255,68,68,.3)", color: "#ff8888", borderRadius: 4, padding: "2px 5px", cursor: "pointer", fontSize: 8, lineHeight: 1.4 } }, "\uD83D\uDD34"), React.createElement("button", { onClick: () => delItem(it.id), title: "Eliminar producto", style: { background: "rgba(255,68,68,.05)", border: "1px solid rgba(255,68,68,.2)", color: "#ff6666", borderRadius: 4, padding: "2px 5px", cursor: "pointer", fontSize: 8, lineHeight: 1.4 } }, "\u2715"))))); }), filt.length === 0 && React.createElement("div", { style: { textAlign: "center", padding: "32px", color: "#4a3a2a", fontSize: 11 } }, "Sin resultados"))), showAI && React.createElement("div", { style: { margin: "14px 22px 0" } }, React.createElement("div", { style: { background: "linear-gradient(135deg,#0d0a1a,#0a0f1a)", border: "1px solid #2a2a4a", borderRadius: 11, padding: 16 } }, React.createElement("div", { style: { display: "flex", justifyContent: "space-between", marginBottom: 10 } }, React.createElement("div", { style: { fontSize: 13, color: "#c8d4f0" } }, "\uD83E\uDD16 An\u00E1lisis IA"), React.createElement("button", { onClick: () => setShowAI(false), style: { background: "none", border: "none", color: "#4a4a6a", cursor: "pointer", fontSize: 14 } }, "\u2715")), aiLoading ? React.createElement("div", { style: { textAlign: "center", padding: "20px", color: "#6e8ec8", fontSize: 12 } }, "\u23F3 Analizando...") : React.createElement("div", null, aiText.split("\n").map((l, i) => l.startsWith("### ") ? React.createElement("div", { key: i, style: { color: "#c8964e", fontWeight: 700, fontSize: 11, marginTop: 10, textTransform: "uppercase" } }, l.replace("### ", "")) : React.createElement("div", { key: i, style: { color: "#c8b99a", fontSize: 11, lineHeight: 1.6 } }, l))))))), view === "distributors" && (React.createElement("div", { style: { padding: "16px 22px" } }, React.createElement("div", { style: { display: "grid", gridTemplateColumns: "repeat(auto-fill,minmax(290px,1fr))", gap: 10 } }, dists.map(d => { const di = inv.filter(i => i.distId === d.id); return (React.createElement("div", { key: d.id, style: { background: "rgba(255,255,255,.025)", border: `1px solid ${d.color}44`, borderRadius: 12 } }, React.createElement("div", { style: { background: `linear-gradient(135deg,${d.color}22,transparent)`, borderBottom: `1px solid ${d.color}22`, padding: "12px 14px", display: "flex", justifyContent: "space-between", alignItems: "flex-start" } }, React.createElement("div", null, React.createElement("div", { style: { fontSize: 8, letterSpacing: 2, color: d.color, textTransform: "uppercase", marginBottom: 2 } }, "Distribuidora"), React.createElement("div", { style: { fontSize: 14, fontWeight: 600, color: "#f0e6d0" } }, d.name), React.createElement("div", { style: { fontSize: 9, color: "#8a7a6a" } }, di.length, " productos")), React.createElement("div", { style: { display: "flex", gap: 4 } }, React.createElement("button", { onClick: () => { setEditDistId(d.id); setNewDist({ ...d }); setShowDistM(true); }, style: { background: `${d.color}22`, border: `1px solid ${d.color}44`, color: d.color, borderRadius: 4, padding: "2px 7px", cursor: "pointer", fontSize: 9 } }, "\u270F\uFE0F"), React.createElement("button", { onClick: () => delDist(d.id), style: { background: "rgba(255,68,68,.1)", border: "1px solid rgba(255,68,68,.3)", color: "#ff6666", borderRadius: 4, padding: "2px 7px", cursor: "pointer", fontSize: 9 } }, "\u2715"))), React.createElement("div", { style: { padding: "10px 14px" } }, React.createElement("div", { style: { display: "grid", gridTemplateColumns: "1fr 1fr", gap: 7, marginBottom: 8 } }, React.createElement("div", null, React.createElement("div", { style: { fontSize: 7, color: "#6a5a4a", letterSpacing: 1, marginBottom: 2 } }, "TELEFONO"), React.createElement("a", { href: `tel:${d.phone}`, style: { fontSize: 10, color: "#c8d4f0", textDecoration: "none" } }, "\uD83D\uDCDE ", d.phone)), React.createElement("div", null, React.createElement("div", { style: { fontSize: 7, color: "#6a5a4a", letterSpacing: 1, marginBottom: 2 } }, "EMAIL"), React.createElement("a", { href: `mailto:${d.email}`, style: { fontSize: 9, color: "#c8d4f0", textDecoration: "none", wordBreak: "break-all" } }, "\u2709\uFE0F ", d.email))), d.rep && React.createElement("div", { style: { marginBottom: 7 } }, React.createElement("div", { style: { fontSize: 7, color: "#6a5a4a", letterSpacing: 1, marginBottom: 1 } }, "REP"), React.createElement("div", { style: { fontSize: 10, color: "#f0e6d0" } }, d.rep, d.repPhone && React.createElement(React.Fragment, null, " \u00B7 ", React.createElement("a", { href: `tel:${d.repPhone}`, style: { color: "#c8d4f0", textDecoration: "none" } }, d.repPhone)))), d.notes && React.createElement("div", { style: { fontSize: 9, color: "#8a7a6a", background: "rgba(255,255,255,.03)", borderRadius: 6, padding: "5px 8px", borderLeft: `2px solid ${d.color}55`, marginBottom: 8 } }, "\uD83D\uDCDD ", d.notes), React.createElement("div", { style: { display: "grid", gridTemplateColumns: "1fr 1fr 1fr", gap: 4 } }, React.createElement("a", { href: `tel:${d.phone}`, style: { background: `${d.color}22`, border: `1px solid ${d.color}44`, color: d.color, borderRadius: 6, padding: "6px 3px", fontSize: 9, fontWeight: 600, textAlign: "center", textDecoration: "none", display: "block" } }, "\uD83D\uDCDE Llamar"), React.createElement("a", { href: `mailto:${d.email}?subject=Pedido de Inventario`, style: { background: "rgba(110,181,200,.1)", border: "1px solid rgba(110,181,200,.3)", color: "#6eb5c8", borderRadius: 6, padding: "6px 3px", fontSize: 9, fontWeight: 600, textAlign: "center", textDecoration: "none", display: "block" } }, "\u2709\uFE0F Email"), React.createElement("button", { onClick: () => { setActiveDist(d.id); setView("orders"); }, style: { background: "rgba(68,204,136,.1)", border: "1px solid rgba(68,204,136,.3)", color: "#44cc88", borderRadius: 6, padding: "6px 3px", fontSize: 9, fontWeight: 600, cursor: "pointer" } }, "\uD83D\uDCE6 Pedido"))))); })))), view === "orders" && (React.createElement("div", { style: { padding: "16px 22px" } }, React.createElement("div", { style: { display: "grid", gridTemplateColumns: "200px 1fr", gap: 12, alignItems: "start" } }, React.createElement("div", null, React.createElement("div", { style: { fontSize: 8, letterSpacing: 2, color: "#8a7a6a", marginBottom: 7, textTransform: "uppercase" } }, "Distribuidora"), dists.map(d => (React.createElement("button", { key: d.id, onClick: () => { setActiveDist(d.id); setOrderQ({}); setAiOrderLines([]); }, style: { width: "100%", background: activeDist === d.id ? `${d.color}2a`: "rgba(255,255,255,.03)", border:`1px solid ${activeDist === d.id ? d.color : “#2a1e12”}`, borderRadius: 8, padding: "8px 10px", cursor: "pointer", textAlign: "left", marginBottom: 4, transition: "all .2s" } }, React.createElement("div", { style: { fontSize: 10, fontWeight: 600, color: activeDist === d.id ? d.color : "#f0e6d0" } }, d.short || d.name), React.createElement("div", { style: { fontSize: 8, color: "#6a5a4a", marginTop: 1 } }, inv.filter(i => i.distId === d.id).length, " productos")))), orders.length > 0 && React.createElement(React.Fragment, null, React.createElement("div", { style: { fontSize: 8, letterSpacing: 2, color: "#8a7a6a", margin: "12px 0 5px", textTransform: "uppercase" } }, "Guardados"), orders.slice(0, 5).map(o => React.createElement("div", { key: o.id, style: { background: "rgba(255,255,255,.03)", border: "1px solid #2a1e12", borderRadius: 7, padding: "7px 9px", marginBottom: 4 } }, React.createElement("div", { style: { fontSize: 9, color: "#f0e6d0", fontWeight: 600 } }, o.distName), React.createElement("div", { style: { fontSize: 8, color: "#6a5a4a" } }, o.date, " \u00B7 ", o.total, "u."))))), !activeDist ? React.createElement("div", { style: { background: "rgba(255,255,255,.02)", border: "1px solid #2a1e12", borderRadius: 11, padding: "44px", textAlign: "center", color: "#4a3a2a", fontSize: 12 } }, "\uD83D\uDCCB Selecciona una distribuidora") : (() => { const d = dists.find(d => d.id === activeDist); return (React.createElement("div", null, React.createElement("div", { style: { display: "flex", justifyContent: "space-between", alignItems: "flex-start", marginBottom: 10, flexWrap: "wrap", gap: 7 } }, React.createElement("div", null, React.createElement("div", { style: { fontSize: 8, letterSpacing: 2, color: d.color, textTransform: "uppercase", marginBottom: 1 } }, "Nuevo Pedido"), React.createElement("div", { style: { fontSize: 15, color: "#f0e6d0", fontWeight: 500 } }, d.name), React.createElement("div", { style: { fontSize: 9, color: "#6a5a4a" } }, d.notes)), React.createElement("div", { style: { display: "flex", gap: 5 } }, React.createElement("button", { onClick: aiOrder, disabled: aiOrderLoading, style: { ...S.btn(d.color), fontSize: 10, opacity: aiOrderLoading ? .5 : 1 } }, aiOrderLoading ? "⏳ Generando..." : "🤖 Auto IA"), React.createElement("button", { onClick: saveOrder, style: { ...S.btn("#44cc88"), fontSize: 10 } }, "\uD83D\uDCBE Guardar"))), aiOrderLines.length > 0 && React.createElement("div", { style: { background: "rgba(110,181,200,.07)", border: "1px solid rgba(110,181,200,.2)", borderRadius: 8, padding: "9px 11px", marginBottom: 9 } }, React.createElement("div", { style: { fontSize: 7, color: "#6e8ec8", letterSpacing: 2, marginBottom: 4 } }, "SUGERENCIA IA"), aiOrderLines.map((l, i) => React.createElement("div", { key: i, style: { fontSize: 10, color: "#c8d4f0", lineHeight: 1.6 } }, "\u2022 ", React.createElement("b", null, l.name), ": ", l.qty, "u \u2014 ", React.createElement("span", { style: { color: "#8a8a9a" } }, l.reason)))), React.createElement("input", { value: orderNote, onChange: e => setOrderNote(e.target.value), placeholder: "Nota (opcional)...", style: { ...S.input, width: "100%", boxSizing: "border-box", marginBottom: 8, padding: "6px 10px", fontSize: 10 } }), React.createElement("div", { style: { background: "rgba(255,255,255,.02)", border: "1px solid #2a1e12", borderRadius: 10, overflow: "hidden" } }, React.createElement("div", { style: { display: "grid", gridTemplateColumns: "2fr 1fr 1fr 1fr 1.2fr", background: "#120c06", padding: "6px 12px", fontSize: 7, color: "#6a5a4a", letterSpacing: 1.5, textTransform: "uppercase", borderBottom: "1px solid #2a1e12" } }, React.createElement("div", null, "Producto"), React.createElement("div", { style: { textAlign: "center" } }, "Stock"), React.createElement("div", { style: { textAlign: "center" } }, "Min"), React.createElement("div", { style: { textAlign: "center" } }, "Estado"), React.createElement("div", { style: { textAlign: "center" } }, "Pedir")), distInv.length === 0 && React.createElement("div", { style: { textAlign: "center", padding: "24px", color: "#4a3a2a", fontSize: 10 } }, "Sin productos asignados"), distInv.map((it, idx) => { const st = stStatus(it); const qty = orderQ[it.id] || 0; return (React.createElement("div", { key: it.id, style: { display: "grid", gridTemplateColumns: "2fr 1fr 1fr 1fr 1.2fr", padding: "8px 12px", borderBottom: idx < distInv.length - 1 ? "1px solid #1a1208" : "none", alignItems: "center", background: qty > 0 ? "rgba(68,204,136,.04)" : "transparent" } }, React.createElement("div", { style: { display: "flex", alignItems: "center", gap: 6 } }, React.createElement("span", { style: { fontSize: 15 } }, it.emoji), React.createElement("div", null, React.createElement("div", { style: { fontSize: 10, color: "#f0e6d0" } }, it.name), React.createElement("div", { style: { fontSize: 8, color: "#6a5a4a" } }, it.unit))), React.createElement("div", { style: { textAlign: "center", fontSize: 12, fontWeight: 700, color: st.c } }, it.stock), React.createElement("div", { style: { textAlign: "center", fontSize: 10, color: "#8a7a6a" } }, it.par), React.createElement("div", { style: { textAlign: "center" } }, React.createElement("span", { style: { background: `${st.c}22`, border: `1px solid ${st.c}55`, color: st.c, borderRadius: 20, padding: "1px 5px", fontSize: 7, fontWeight: 700 } }, st.l)), React.createElement("div", { style: { textAlign: "center" } }, React.createElement("div", { style: { display: "flex", alignItems: "center", justifyContent: "center", gap: 2 } }, React.createElement("button", { onClick: () => setOrderQ(p => ({ ...p, [it.id]: Math.max(0, (p[it.id] || 0) - 1) })), style: S.mini }, "\u2212"), React.createElement("span", { style: { fontSize: 13, fontWeight: 700, color: qty > 0 ? "#44cc88" : "#4a3a2a", minWidth: 22, textAlign: "center" } }, qty), React.createElement("button", { onClick: () => setOrderQ(p => ({ ...p, [it.id]: (p[it.id] || 0) + 1 })), style: S.mini }, "+"))))); })), oTotal > 0 && React.createElement("div", { style: { marginTop: 7, textAlign: "right", fontSize: 11, color: "#44cc88", fontWeight: 600 } }, "Total: ", oTotal, " unidades"))); })()))), showAdd && (React.createElement("div", { style: { position: "fixed", inset: 0, background: "rgba(0,0,0,.88)", zIndex: 200, display: "flex", alignItems: "center", justifyContent: "center" } }, React.createElement("div", { style: { background: "#150f08", border: "1px solid #3a2a1a", borderRadius: 13, padding: 22, width: 340, boxShadow: "0 20px 60px rgba(0,0,0,.8)", maxHeight: "90vh", overflowY: "auto" } }, React.createElement("div", { style: { fontSize: 14, marginBottom: 14, color: "#c8964e" } }, "+ A\u00F1adir Producto"), [["Nombre", "name", "text"], ["Unidad", "unit", "text"], ["Stock", "stock", "number"], ["Backup", "backup", "number"], ["Minimo", "par", "number"]].map(([l, k, t]) => (React.createElement("div", { key: k, style: { marginBottom: 8 } }, React.createElement("div", { style: { fontSize: 8, color: "#6a5a4a", marginBottom: 2 } }, l), React.createElement("input", { type: t, value: newItem[k], onChange: e => setNewItem(p => ({ ...p, [k]: t === "number" ? +e.target.value : e.target.value })), style: { ...S.input, width: "100%", boxSizing: "border-box", fontSize: 11, padding: "5px 8px" } })))), React.createElement("div", { style: { marginBottom: 8 } }, React.createElement("div", { style: { fontSize: 8, color: "#6a5a4a", marginBottom: 2 } }, "Categoria"), React.createElement("select", { value: newItem.category, onChange: e => setNewItem(p => ({ ...p, category: e.target.value, unit: UNIT_DEF[e.target.value] || "" })), style: { width: "100%", background: "#1a1208", border: "1px solid #2a1e12", borderRadius: 6, padding: "5px 8px", color: "#f0e6d0", fontSize: 11, outline: "none" } }, CATS.filter(c => c !== "Todos").map(c => React.createElement("option", { key: c, value: c }, CAT_EMO[c] || "", " ", c)))), React.createElement("div", { style: { marginBottom: 14 } }, React.createElement("div", { style: { fontSize: 8, color: "#6a5a4a", marginBottom: 2 } }, "Distribuidora"), React.createElement("select", { value: newItem.distId, onChange: e => setNewItem(p => ({ ...p, distId: +e.target.value })), style: { width: "100%", background: "#1a1208", border: "1px solid #2a1e12", borderRadius: 6, padding: "5px 8px", color: "#f0e6d0", fontSize: 11, outline: "none" } }, React.createElement("option", { value: "" }, "\u2014 Sin asignar \u2014"), dists.map(d => React.createElement("option", { key: d.id, value: d.id }, d.name)))), React.createElement("div", { style: { display: "flex", gap: 6 } }, React.createElement("button", { onClick: addItem, style: S.btn("#c8964e") }, "A\u00F1adir"), React.createElement("button", { onClick: () => setShowAdd(false), style: S.btn("#2a1e12", "#8a7a6a") }, "Cancelar"))))), showDistM && (React.createElement("div", { style: { position: "fixed", inset: 0, background: "rgba(0,0,0,.88)", zIndex: 200, display: "flex", alignItems: "center", justifyContent: "center" } }, React.createElement("div", { style: { background: "#150f08", border: "1px solid #3a2a1a", borderRadius: 13, padding: 22, width: 380, boxShadow: "0 20px 60px rgba(0,0,0,.8)", maxHeight: "92vh", overflowY: "auto" } }, React.createElement("div", { style: { fontSize: 14, marginBottom: 14, color: "#c8964e" } }, editDistId ? "✏️ Editar" : "+ Nueva", " Distribuidora"), [["Nombre", "name", "text"], ["Nombre corto", "short", "text"], ["Telefono", "phone", "tel"], ["Email", "email", "email"], ["Representante", "rep", "text"], ["Tel. Rep", "repPhone", "tel"]].map(([l, k, t]) => (React.createElement("div", { key: k, style: { marginBottom: 8 } }, React.createElement("div", { style: { fontSize: 8, color: "#6a5a4a", marginBottom: 2 } }, l), React.createElement("input", { type: t, value: newDist[k] || "", onChange: e => setNewDist(p => ({ ...p, [k]: e.target.value })), style: { ...S.input, width: "100%", boxSizing: "border-box", fontSize: 11, padding: "5px 8px" } })))), React.createElement("div", { style: { marginBottom: 8 } }, React.createElement("div", { style: { fontSize: 8, color: "#6a5a4a", marginBottom: 4 } }, "Categorias"), React.createElement("div", { style: { display: "flex", flexWrap: "wrap", gap: 3 } }, CATS.filter(c => c !== "Todos").map(c => { const sel = newDist.categories?.includes(c); return React.createElement("button", { key: c, onClick: () => setNewDist(p => ({ ...p, categories: sel ? p.categories.filter(x => x !== c) : [...(p.categories || []), c] })), style: { background: sel ? (CAT_CLR[c] || "#888") : "rgba(255,255,255,.05)", border: `1px solid ${sel ? CAT_CLR[c] || “#888” : “#2a1e12”}`, borderRadius: 20, padding: "2px 8px", color: sel ? "#0a0704" : "#6a5a4a", fontSize: 8, cursor: "pointer" } }, CAT_EMO[c] || "", " ", c); }))), React.createElement("div", { style: { marginBottom: 8 } }, React.createElement("div", { style: { fontSize: 8, color: "#6a5a4a", marginBottom: 4 } }, "Color"), React.createElement("div", { style: { display: "flex", gap: 4, flexWrap: "wrap" } }, PALETTE.map(c => React.createElement("button", { key: c, onClick: () => setNewDist(p => ({ ...p, color: c })), style: { width: 20, height: 20, borderRadius: "50%", background: c, border: newDist.color === c ? "3px solid #fff" : "2px solid transparent", cursor: "pointer", padding: 0 } })))), React.createElement("div", { style: { marginBottom: 14 } }, React.createElement("div", { style: { fontSize: 8, color: "#6a5a4a", marginBottom: 2 } }, "Notas"), React.createElement("textarea", { value: newDist.notes || "", onChange: e => setNewDist(p => ({ ...p, notes: e.target.value })), rows: 2, style: { width: "100%", background: "rgba(255,255,255,.05)", border: "1px solid #2a1e12", borderRadius: 6, padding: "5px 8px", color: "#f0e6d0", fontSize: 10, outline: "none", resize: "vertical", boxSizing: "border-box" } })), React.createElement("div", { style: { display: "flex", gap: 6 } }, React.createElement("button", { onClick: saveDist, style: S.btn("#c8964e") }, editDistId ? "Guardar" : "Añadir"), React.createElement("button", { onClick: () => setShowDistM(false), style: S.btn("#2a1e12", "#8a7a6a") }, "Cancelar"))))), timelineItem && (React.createElement("div", { style: { position: "fixed", inset: 0, background: "rgba(0,0,0,.9)", zIndex: 300, display: "flex", alignItems: "center", justifyContent: "center", padding: 16 }, onClick: () => setTimelineItem(null) }, React.createElement("div", { style: { background: "#0d0a06", border: "1px solid #2a1e12", borderRadius: 16, width: "100%", maxWidth: 500, maxHeight: "90vh", overflowY: "auto", boxShadow: "0 30px 80px rgba(0,0,0,.8)" }, onClick: e => e.stopPropagation() }, React.createElement("div", { style: { padding: "18px 20px 14px", borderBottom: "1px solid #1e1208", display: "flex", justifyContent: "space-between", alignItems: "center", position: "sticky", top: 0, background: "#0d0a06", zIndex: 1 } }, React.createElement("div", null, React.createElement("div", { style: { fontSize: 9, letterSpacing: 3, color: "#c8964e", textTransform: "uppercase", marginBottom: 3 } }, "Rastreo de Ciclos"), React.createElement("div", { style: { fontSize: 16, color: "#f0e6d0", fontWeight: 500 } }, timelineItem.emoji, " ", timelineItem.name)), React.createElement("button", { onClick: () => setTimelineItem(null), style: { background: "none", border: "none", color: "#6a5a4a", cursor: "pointer", fontSize: 20, lineHeight: 1 } }, "\u2715")), React.createElement("div", { style: { padding: "16px 20px" } }, (() => { const cyc = calcCycles(timelineItem.history); if (cyc.avgDays > 0) { const daysLeft = timelineItem.lastArrived ? Math.max(0, cyc.avgDays - Math.round((Date.now() - new Date(timelineItem.lastArrived)) / 86400000)) : null; return (React.createElement("div", { style: { display: "grid", gridTemplateColumns: "repeat(4,1fr)", gap: 7, marginBottom: 18 } }, [ { l: "Ciclo prom.", v: `${cyc.avgDays}d`, c: "#6eb5c8" }, { l: "Ciclos reales", v: cyc.cycles, c: "#44cc88" }, { l: "Vel. real", v: `${parseFloat((timelineItem.par / cyc.avgDays * 7).toFixed(1))}/sem`, c: "#c8964e" }, { l: "Días restantes", v: daysLeft !== null ? `~${daysLeft}d`: "--", c: daysLeft !== null && daysLeft <= 3 ? "#ff4444" : "#ffaa00" }, ].map((s, i) => (React.createElement("div", { key: i, style: { background: "rgba(255,255,255,.03)", border: "1px solid #1e1208", borderRadius: 8, padding: "9px 10px", textAlign: "center" } }, React.createElement("div", { style: { fontSize: 7, color: "#6a5a4a", letterSpacing: 1, textTransform: "uppercase", marginBottom: 3 } }, s.l), React.createElement("div", { style: { fontSize: 14, fontWeight: 700, color: s.c } }, s.v)))))); } return null; })(), React.createElement("div", { style: { background: "rgba(110,181,200,.06)", border: "1px solid rgba(110,181,200,.2)", borderRadius: 11, padding: "14px 16px", marginBottom: 16 } }, React.createElement("div", { style: { fontSize: 9, letterSpacing: 2, color: "#6eb5c8", textTransform: "uppercase", marginBottom: 12 } }, "\uD83D\uDCC5 Registrar Fecha Manualmente"), React.createElement("div", { style: { display: "flex", gap: 5, marginBottom: 12 } }, [ ["arrived", "📦 Llegó", "rgba(68,204,136,.15)", "rgba(68,204,136,.4)", "#44cc88"], ["retired", "🗑️ Retirado", "rgba(255,170,0,.12)", "rgba(255,170,0,.4)", "#ffaa44"], ["finished", "🔴 Agotado", "rgba(255,68,68,.1)", "rgba(255,68,68,.4)", "#ff8888"], ].map(([val, label, bg, border, clr]) => (React.createElement("button", { key: val, onClick: () => setManualType(val), style: { flex: 1, background: manualType === val ? bg : "rgba(255,255,255,.03)", border:`1px solid ${manualType === val ? border : “#1e1208”}`, borderRadius: 8, padding: "7px 4px", cursor: "pointer", color: manualType === val ? clr : "#6a5a4a", fontSize: 10, fontWeight: manualType === val ? 700 : 400, transition: "all .2s" } }, label)))), React.createElement("div", { style: { marginBottom: 10 } }, React.createElement("div", { style: { fontSize: 8, color: "#4a6a7a", letterSpacing: 1, textTransform: "uppercase", marginBottom: 4 } }, "Fecha"), React.createElement("input", { type: "date", value: manualDate, onChange: e => { setManualDate(e.target.value); setManualErr(""); }, max: new Date().toISOString().split("T")[0], style: { width: "100%", boxSizing: "border-box", background: "rgba(255,255,255,.05)", border: "1px solid #2a1e12", borderRadius: 7, padding: "8px 10px", color: "#f0e6d0", fontSize: 12, outline: "none", colorScheme: "dark" } })), (manualType === "arrived" || manualType === "retired") && (React.createElement("div", { style: { marginBottom: 10 } }, React.createElement("div", { style: { fontSize: 8, color: "#4a6a7a", letterSpacing: 1, textTransform: "uppercase", marginBottom: 4 } }, manualType === "arrived" ? "Cantidad que llegó" : "Cantidad retirada"), React.createElement("input", { type: "number", value: manualQty, onChange: e => setManualQty(e.target.value), placeholder: `Ej: ${timelineItem.par}`, min: 1, style: { width: "100%", boxSizing: "border-box", background: "rgba(255,255,255,.05)", border: "1px solid #2a1e12", borderRadius: 7, padding: "8px 10px", color: "#f0e6d0", fontSize: 12, outline: "none" } }))), React.createElement("div", { style: { marginBottom: 12 } }, React.createElement("div", { style: { fontSize: 8, color: "#4a6a7a", letterSpacing: 1, textTransform: "uppercase", marginBottom: 4 } }, "Nota (opcional)"), React.createElement("input", { type: "text", value: manualNote, onChange: e => setManualNote(e.target.value), placeholder: "Ej: lleg\u00F3 con el pedido de Southern, evento especial...", style: { width: "100%", boxSizing: "border-box", background: "rgba(255,255,255,.05)", border: "1px solid #2a1e12", borderRadius: 7, padding: "8px 10px", color: "#f0e6d0", fontSize: 11, outline: "none" } })), manualErr && React.createElement("div", { style: { color: "#ff6666", fontSize: 10, marginBottom: 8, background: "rgba(255,68,68,.08)", borderRadius: 6, padding: "4px 8px" } }, "\u26A0\uFE0F ", manualErr), React.createElement("button", { onClick: addManualEntry, style: { width: "100%", background: "#6eb5c8", border: "none", borderRadius: 8, padding: "9px", color: "#06080a", fontSize: 12, fontWeight: 700, cursor: "pointer" } }, "Guardar fecha")), React.createElement("div", { style: { display: "grid", gridTemplateColumns: "1fr 1fr 1fr", gap: 6, marginBottom: 16 } }, React.createElement("button", { onClick: () => { markArrived(timelineItem.id); const updated = inv.find(i => i.id === timelineItem.id); if (updated) setTimelineItem({ ...updated }); }, style: { background: "rgba(68,204,136,.1)", border: "1px solid rgba(68,204,136,.25)", color: "#44cc88", borderRadius: 8, padding: "8px 4px", cursor: "pointer", fontSize: 9, fontWeight: 600 } }, "\uD83D\uDCE6 Lleg\u00F3 hoy"), React.createElement("button", { onClick: () => { setTimelineItem(null); setRetireItem(timelineItem); setRetireQty("1"); setRetireReason(""); }, style: { background: "rgba(255,170,0,.08)", border: "1px solid rgba(255,170,0,.25)", color: "#ffaa44", borderRadius: 8, padding: "8px 4px", cursor: "pointer", fontSize: 9, fontWeight: 600 } }, "\uD83D\uDDD1\uFE0F Retirar hoy"), React.createElement("button", { onClick: () => { markFinished(timelineItem.id); const updated = inv.find(i => i.id === timelineItem.id); if (updated) setTimelineItem({ ...updated }); }, style: { background: "rgba(255,68,68,.08)", border: "1px solid rgba(255,68,68,.25)", color: "#ff8888", borderRadius: 8, padding: "8px 4px", cursor: "pointer", fontSize: 9, fontWeight: 600 } }, "\uD83D\uDD34 Agot\u00F3 hoy")), React.createElement("div", { style: { fontSize: 9, letterSpacing: 2, color: "#6a5a4a", textTransform: "uppercase", marginBottom: 10 } }, "Historial de eventos"), (!timelineItem.history || timelineItem.history.length === 0) ? React.createElement("div", { style: { textAlign: "center", padding: "24px", color: "#3a2a1a", fontSize: 11, border: "1px dashed #2a1e12", borderRadius: 10 } }, "Sin eventos a\u00FAn.", React.createElement("br", null), React.createElement("span", { style: { fontSize: 9, color: "#2a1a0a" } }, "Registra una fecha arriba para empezar a rastrear el patr\u00F3n.")) : React.createElement("div", { style: { position: "relative" } }, React.createElement("div", { style: { position: "absolute", left: 15, top: 0, bottom: 0, width: 2, background: "linear-gradient(180deg,#c8964e33,transparent)", borderRadius: 1 } }), [...timelineItem.history].reverse().map((ev, i) => { const isArr = ev.type === "arrived", isRet = ev.type === "retired"; const clr = isArr ? "#44cc88" : isRet ? "#ffaa44" : "#ff8888"; const bdr = isArr ? "rgba(68,204,136,.2)" : isRet ? "rgba(255,170,0,.2)" : "rgba(255,68,68,.12)"; const lbl = isArr ? "📦 Llegada" : isRet ? "🗑️ Retirado" : "🔴 Agotado"; return (React.createElement("div", { key: i, style: { display: "flex", alignItems: "flex-start", gap: 10, marginBottom: 10, position: "relative" } }, React.createElement("div", { style: { width: 30, height: 30, borderRadius: "50%", background: isArr ? "rgba(68,204,136,.18)" : isRet ? "rgba(255,170,0,.12)" : "rgba(255,68,68,.12)", border: `2px solid ${clr}`, display: "flex", alignItems: "center", justifyContent: "center", fontSize: 12, flexShrink: 0, zIndex: 1 } }, isArr ? "📦" : isRet ? "🗑️" : "🔴"), React.createElement("div", { style: { flex: 1, background: "rgba(255,255,255,.025)", border: `1px solid ${bdr}`, borderRadius: 8, padding: "8px 11px" } }, React.createElement("div", { style: { display: "flex", justifyContent: "space-between", alignItems: "flex-start", gap: 8 } }, React.createElement("div", { style: { fontSize: 11, fontWeight: 600, color: clr } }, lbl, ev.manual && React.createElement("span", { style: { fontSize: 8, color: "#4a6a7a", marginLeft: 5, fontWeight: 400 } }, "(manual)")), React.createElement("div", { style: { fontSize: 9, color: "#c8964e", fontWeight: 600, whiteSpace: "nowrap" } }, ev.date)), React.createElement("div", { style: { fontSize: 9, color: "#8a7a6a", marginTop: 3 } }, ev.ts && ev.ts !== "manual" && React.createElement(React.Fragment, null, React.createElement("span", { style: { color: "#5a6a7a" } }, ev.ts), " \u00B7 "), "Por: ", React.createElement("span", { style: { color: "#c8d0d8" } }, ev.user), ev.qty ? React.createElement(React.Fragment, null, " \u00B7 ", React.createElement("span", { style: { color: clr, fontWeight: 600 } }, ev.qty), " unidad", ev.qty !== 1 ? "es" : "") : ev.stock !== undefined && isArr ? React.createElement(React.Fragment, null, " \u00B7 Stock: ", React.createElement("span", { style: { color: "#44cc88", fontWeight: 600 } }, ev.stock)) : ""), ev.note && React.createElement("div", { style: { fontSize: 9, color: "#7a8a6a", marginTop: 3, fontStyle: "italic" } }, "\"", ev.note, "\"")))); })))))), retireItem && (React.createElement("div", { style: { position: "fixed", inset: 0, background: "rgba(0,0,0,.88)", zIndex: 300, display: "flex", alignItems: "center", justifyContent: "center", padding: 16 }, onClick: () => setRetireItem(null) }, React.createElement("div", { style: { background: "#100c06", border: "1px solid #3a2a0a", borderRadius: 14, width: "100%", maxWidth: 380, boxShadow: "0 24px 70px rgba(0,0,0,.8)", overflow: "hidden" }, onClick: e => e.stopPropagation() }, React.createElement("div", { style: { background: "linear-gradient(135deg,rgba(255,170,0,.12),transparent)", borderBottom: "1px solid rgba(255,170,0,.15)", padding: "16px 18px", display: "flex", justifyContent: "space-between", alignItems: "center" } }, React.createElement("div", null, React.createElement("div", { style: { fontSize: 9, letterSpacing: 3, color: "#ffaa44", textTransform: "uppercase", marginBottom: 2 } }, "Registrar Retiro"), React.createElement("div", { style: { fontSize: 15, color: "#f0e6d0", fontWeight: 500 } }, retireItem.emoji, " ", retireItem.name), React.createElement("div", { style: { fontSize: 9, color: "#8a7a6a", marginTop: 1 } }, "Stock actual: ", React.createElement("span", { style: { color: "#f0e6d0", fontWeight: 600 } }, retireItem.stock), " unidades")), React.createElement("button", { onClick: () => setRetireItem(null), style: { background: "none", border: "none", color: "#6a5a4a", cursor: "pointer", fontSize: 18, lineHeight: 1 } }, "\u2715")), React.createElement("div", { style: { padding: "16px 18px" } }, React.createElement("div", { style: { marginBottom: 14 } }, React.createElement("div", { style: { fontSize: 9, color: "#8a7a6a", letterSpacing: 1, textTransform: "uppercase", marginBottom: 5 } }, "Cantidad retirada"), React.createElement("div", { style: { display: "flex", alignItems: "center", gap: 8 } }, React.createElement("button", { onClick: () => setRetireQty(q => String(Math.max(1, parseInt(q || 1) - 1))), style: { ...S.mini, width: 28, height: 28, fontSize: 16 } }, "\u2212"), React.createElement("input", { type: "number", value: retireQty, onChange: e => setRetireQty(e.target.value), min: 1, max: retireItem.stock, style: { flex: 1, background: "rgba(255,255,255,.06)", border: "1px solid rgba(255,170,0,.3)", borderRadius: 8, padding: "9px 12px", color: "#f0e6d0", fontSize: 16, fontWeight: 700, textAlign: "center", outline: "none" } }), React.createElement("button", { onClick: () => setRetireQty(q => String(Math.min(retireItem.stock, parseInt(q || 1) + 1))), style: { ...S.mini, width: 28, height: 28, fontSize: 16 } }, "+")), React.createElement("div", { style: { fontSize: 9, color: "#6a5a4a", marginTop: 5, textAlign: "center" } }, "Stock restante: ", React.createElement("span", { style: { color: retireItem.stock - (parseInt(retireQty) || 1) <= retireItem.par ? "#ff8888" : "#f0e6d0", fontWeight: 600 } }, Math.max(0, retireItem.stock - (parseInt(retireQty) || 1))), " unidades")), React.createElement("div", { style: { marginBottom: 16 } }, React.createElement("div", { style: { fontSize: 9, color: "#8a7a6a", letterSpacing: 1, textTransform: "uppercase", marginBottom: 5 } }, "Raz\u00F3n del retiro ", React.createElement("span", { style: { color: "#4a3a2a", fontWeight: 400 } }, "(opcional)")), React.createElement("div", { style: { display: "flex", gap: 5, flexWrap: "wrap", marginBottom: 8 } }, ["Vencido", "Roto/dañado", "Muestra", "Consumo interno", "Otro"].map(r => (React.createElement("button", { key: r, onClick: () => setRetireReason(r), style: { background: retireReason === r ? "rgba(255,170,0,.2)" : "rgba(255,255,255,.04)", border: `1px solid ${retireReason === r ? “rgba(255,170,0,.4)” : “#2a1e12”}`, borderRadius: 20, padding: "3px 9px", color: retireReason === r ? "#ffaa44" : "#6a5a4a", fontSize: 9, cursor: "pointer", fontWeight: retireReason === r ? 600 : 400 } }, r)))), React.createElement("input", { type: "text", value: retireReason, onChange: e => setRetireReason(e.target.value), placeholder: "O escribe una raz\u00F3n...", style: { ...S.input, width: "100%", boxSizing: "border-box", fontSize: 11, padding: "6px 9px" } })), React.createElement("div", { style: { background: "rgba(255,170,0,.06)", border: "1px solid rgba(255,170,0,.15)", borderRadius: 8, padding: "9px 11px", marginBottom: 14, fontSize: 9, color: "#8a7a6a", lineHeight: 1.6 } }, "\uD83D\uDDD1\uFE0F Esto reducir\u00E1 el stock en ", React.createElement("span", { style: { color: "#ffaa44", fontWeight: 600 } }, parseInt(retireQty) || 1), " unidad", (parseInt(retireQty) || 1) !== 1 ? "es" : "", " y registrar\u00E1 la fecha de hoy (", React.createElement("span", { style: { color: "#c8964e" } }, dateNow()), ") en el historial del producto."), React.createElement("div", { style: { display: "grid", gridTemplateColumns: "1fr 1fr", gap: 8 } }, React.createElement("button", { onClick: async () => { await markRetired(retireItem.id, parseInt(retireQty) || 1, retireReason); setRetireItem(null); }, style: { background: "rgba(255,170,0,.18)", border: "1px solid rgba(255,170,0,.4)", color: "#ffaa44", borderRadius: 9, padding: "10px", cursor: "pointer", fontSize: 12, fontWeight: 700 } }, "\uD83D\uDDD1\uFE0F Confirmar retiro"), React.createElement("button", { onClick: () => setRetireItem(null), style: { background: "rgba(255,255,255,.04)", border: "1px solid #2a1e12", color: "#8a7a6a", borderRadius: 9, padding: "10px", cursor: "pointer", fontSize: 12 } }, "Cancelar")))))), React.createElement("style", null, `@keyframes fadeIn{from{opacity:0;transform:translateY(-6px)}to{opacity:1;transform:translateY(0)}} button:hover{opacity:.82} input::placeholder,textarea::placeholder{color:#3a4a5a} input[type=“date”]::-webkit-calendar-picker-indicator{filter:invert(.6)}`))); } // ═══════════════════════════════════════════════════════════════════════════════ // ADMIN APP // ═══════════════════════════════════════════════════════════════════════════════ function AdminApp({ pin, adminUser, staff, isSuperAdmin, onPin, onAdminUser, onStaff, onLogout }) { const [tab, setTab] = useState("live"); const [logs, setLogs] = useState([]); const [active, setActive] = useState({}); const [inv, setInv] = useState([]); const [dists, setDists] = useState([]); const [loading, setLoading] = useState(true); const [filterUser, setFUser] = useState("Todos"); const [filterType, setFType] = useState("Todos"); // PIN change const [showPin, setShowPin] = useState(false); const [pUser, setPUser] = useState(""); const [pCur, setPCur] = useState(""); const [pNew, setPNew] = useState(""); const [pConf, setPConf] = useState(""); const [pErr, setPErr] = useState(""); const [pOk, setPOk] = useState(false); // Staff const [newSName, setNewSName] = useState(""); const [sErr, setSErr] = useState(""); // Shopping list const [thresh, setThresh] = useState(2); const [copied, setCopied] = useState(false); const pollRef = useRef(null); const refresh = useCallback(async () => { const [l, u, i, d] = await Promise.all([ shGet("lp:logs", []), shGet("lp:active", {}), shGet("lp:inventory", INIT_INV), shGet("lp:distributors", INIT_DISTS), ]); const now = Date.now(); const fresh = Object.fromEntries(Object.entries(u).filter(([, v]) => now - v.lastSeen < 60000)); setLogs(l); setActive(fresh); setInv(i); setDists(d); setLoading(false); }, []); useEffect(() => { refresh(); pollRef.current = setInterval(refresh, POLL_MS); return () => clearInterval(pollRef.current); }, [refresh]); // PIN / credential change const doChangePin = async () => { setPErr(""); setPOk(false); // Validate current PIN if (!pCur) { setPErr("Escribe el PIN actual"); return; } if (pCur !== pin) { setPErr(`PIN incorrecto. El PIN actual es el que usaste para entrar.`); return; } // Need at least one change const hasNewUser = pUser.trim().length > 0; const hasNewPin = pNew.trim().length > 0; if (!hasNewUser && !hasNewPin) { setPErr("Escribe un nuevo usuario y/o un nuevo PIN"); return; } if (hasNewUser && pUser.trim().length < 2) { setPErr("El usuario debe tener al menos 2 caracteres"); return; } if (hasNewPin && pNew.length < 4) { setPErr("El PIN debe tener al menos 4 caracteres"); return; } if (hasNewPin && pNew !== pConf) { setPErr("Los PINs nuevos no coinciden"); return; } // Apply changes if (hasNewPin) await onPin(pNew.trim()); if (hasNewUser) await onAdminUser(pUser.trim()); setPOk(true); setPCur(""); setPNew(""); setPConf(""); setPUser(""); setTimeout(() => { setShowPin(false); setPOk(false); }, 2000); }; // Staff handlers const addStaff = () => { const n = newSName.trim(); setSErr(""); if (!n) { setSErr("Escribe un nombre"); return; } if (staff.find(s => s.toLowerCase() === n.toLowerCase())) { setSErr("Ese nombre ya existe"); return; } onStaff([...staff, n]); setNewSName(""); }; const removeStaff = n => onStaff(staff.filter(s => s !== n)); // Computed const activeArr = Object.values(active); const tStock = inv.reduce((a, b) => a + b.stock, 0); const crits = inv.filter(i => i.stock <= i.par); const nLow = inv.filter(i => i.stock <= i.par * 2).length; const todayLogs = logs.filter(l => l.date === dateNow()); const addCount = todayLogs.filter(l => l.type === ACT.ADD).length; const delCount = todayLogs.filter(l => l.type === ACT.DEL).length; const adjCount = todayLogs.filter(l => l.type === ACT.STOCK || l.type === ACT.BACKUP).length; const allUsers = ["Todos", ...new Set(logs.map(l => l.user))]; const allTypes = ["Todos", ...Object.keys(ACT)]; const filtLogs = logs.filter(l => (filterUser === "Todos" || l.user === filterUser) && (filterType === "Todos" || l.type === filterType)); // Shopping list const needsList = inv.filter(i => i.stock < thresh); const byDist = dists.map(d => ({ dist: d, items: needsList.filter(i => i.distId === d.id) })).filter(g => g.items.length > 0); const unassigned = needsList.filter(i => !i.distId || !dists.find(d => d.id === i.distId)); const buildText = () => { const lines = [`📋 LISTA DE COMPRAS – ${dateNow()}`, `Stock menor a ${thresh} unidades`, "─".repeat(40)]; byDist.forEach(({ dist, items }) => { lines.push(`\n🏢 ${dist.name.toUpperCase()}`); lines.push(`   📞 ${dist.phone}  ✉️ ${dist.email}`); if (dist.rep) lines.push(`   Rep: ${dist.rep}${dist.repPhone ? ` · ${dist.repPhone}` : “”}`); lines.push(`   ${“─”.repeat(30)}`); items.forEach(i => { const need = Math.max(0, thresh - i.stock); lines.push(`   ${i.emoji} ${i.name} (${i.unit})`); lines.push(`      Stock: ${i.stock} | Min: ${i.par} | Pedir: +${need}`); }); }); if (unassigned.length > 0) { lines.push("\n⚠️ SIN DISTRIBUIDORA"); unassigned.forEach(i => lines.push(`   ${i.emoji} ${i.name} – Stock: ${i.stock}`)); } lines.push(`\n${“─”.repeat(40)}\nTotal: ${needsList.length} productos a reponer`);
return lines.join(”\n”);
};
const
doCopy = () => { navigator.clipboard.writeText(buildText()).then(() => { setCopied(true); setTimeout(() => setCopied(false), 2500); }); };
